...
import Travellvedio from "../images/vediofront3.mp4";
...
<div id="carouselExample" class="carousel slide">
  <div class="carousel-inner">
    ...
    <div className="content-home">
     <h1 style={{color:"black",fontWeight:"bold"}}>What You Want....?</h1>
        ...
        <div class="row g-2">
          <div class="col-md-6">
            <div class="tour-discription">
              <h2 className="drop-discription-top">Tour</h2>
              <p>tour is a you can avilabe trip plans and booking as you can like so plces We provide giude packages and plans for you</p>
           </div>
          </div>
    
          <div class="col-md-6">
            <div class="drop-discription">
              <h2 className="tour-discription-top">Drop</h2>
              <p>tour is a you can avilabe trip plans and booking as you can like so plces We provide giude route can choice your can </p>
            </div>
          </div>
    ...
    <div className="content-home">
     <h1 style={{color:"black",fontWeight:"bold"}}>Welcome</h1>
      ...
      <div class="container overflow-hidden text-center">
        <div class="row g-2">
          ...
          <div class="col-md-6">
            <div class="drop-discription">
              <h2 className="tour-discription-top">Route</h2>
              <p>tour is a you can avilabe trip plans and booking as you can like so plces We provide giude route can choice your can </p>
            </div>
          </div>
